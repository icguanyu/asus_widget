const lan = {
  ...
  GPT: {
    LAYOUT: {
      ...
      CANCEL: "Peruuta",
      WAIT: "Odota Hetki.",
      INPUT: "Kysy kysymyksesi tässä",
      TRANSFER_TOAGENT: "Siirrä asiakaspalvelijalle.",
      READMORE: "Voit myös etsiä vastausta usein kysytyistä kysymyksistä.",
      COLLAPSE: "Sulje",
    },
    HEAD: {
      LEAVE: "Poistu",
      CREATE_NEW: "Aloita uudelleen",
    },
    ENTRANCE: {
      POLICY: "Privacy Policy",
      AGREE: "Painamalla aloita, Hyväksyt ASUS Privacy Policy.",
    },
    MESSAGE: {
      WAIT: "Odota hetki kun keräämme tietoja, vastaamme hetken kuluttua!",
    },
    END: "keskustelu päättyi",
    END_MSG: "Kiitos että valitsit ASUS toivotamme hyvää päivän jatkoa!",
    BACKHOME: "Aloita keskustelu uudelleen",
  },
};
export default lan;

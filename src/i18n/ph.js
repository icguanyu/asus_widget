const lan = {
  ...
  SYS: {
    HEAD: "System",
    NOSERVICE:
      "Sorry, ASUS Chat Service is not available for your selected country or region.",
    CHECK_FILESIZE:
  ...
  IDLE: {
    HEAD:
      "You have been idle for a while. Would you like to continue the session?",
    BUTTON: "Continue",
  },
  DISCONNECT: {
    HEAD: "The chat session has finished",
    BUTTON: "Finish",
  },
  LAYOUT: {
    PREV_STEP: "Previous",
  ...
  POLICY: {
    ...
    CONFIRM_COUNTRY: {
      ...
      P1:
        "You are now visiting ASUS Online Customer Service for Philippines, which is different from your current region. According to the ASUS Warranty Terms, not every ASUS product is applicable for ASUS International Warranty and Support service. If the above regional site you are visiting is not the region where you bought your ASUS product or is different from your current region, it may affect your rights. You can continue using ASUS Online Customer Service for Philippines or change the ASUS Online Customer Service to your region.",
      P2: "",
      P3: "",
      B1: "Switch to ASUS",
      B2: "Website",
  ...
  SURVEY: {
    ...
    PREPARE: "Creating the Chat room, please wait a moment",
    START: "Start the Chat",
    AGE_LIMIT: "Age Limit",
    AGE_LIMIT_DESC: "You do not meet the age requirements to use ASUS Chat",
    REPEAT_ENTRY: {
      H1: "An existing chat room has been detected",
      P1:
        "Are you sure you want to start a new session? Note that the old sessions will automatically end.",
      B0: "Confirm",
      B1: "Cancel",
    },
  },
  ...
  CHATROOM: {
    ...
    SAT_SURVEY: {
      ...
      OTHER_OPTION: "Other",
      OTHER_REASON: "Please fill in the reason",
      SEND: "Send",
    },
    CLOSE: {
  ...
  CHAT_CLOSE: {
    H1:
      "As your network has been down for more than 300 seconds, we will have to terminate this session.",
    DESC:
      "Please ensure that you are in a safe location with a strong internet or data connection to avoid any interruptions. We apologize for any inconvenience",
    CLOSE: "Close window",
  },
  SURVEY_DONE: {
    H1: "You have completed the Service Satisfaction Survey. Thank you",
    P1:
  ...
  AGENT_OFFLINE: {
    ...
    DESC:
      'You can also choose to end the Chat and begin the Survey or click "Start new Chat", and we will immediately assign a new agent to continue your Chat. We apologize for any inconvenience caused',
    AGAIN: "Start new Chat",
  },
  VIDEOCALL: {

const lan = {
  ...
  IDLE: {
    HEAD: "You have been idle for a while. Would you like to continue the session?",
    BUTTON: "Continue",
  },
  DISCONNECT: {
  ...
  SURVEY: {
    ...
    REPEAT_ENTRY: {
      ...
      P1: "Are you sure you want to start a new session? Note that the old sessions will automatically end.",
      B0: "Confirm",
      B1: "Cancel",
    },
  },
  ...
  CHAT_CLOSE: {
    H1: "As your network has been down for more than 300 seconds, we will have to terminate this session.",
    DESC: "Please ensure that you are in a safe location with a strong internet or data connection to avoid any interruptions. We apologize for any inconvenience",
    CLOSE: "Close window",
  },
  SURVEY_DONE: {
  ...
  AGENT_OFFLINE: {
    ...
    DESC: 'You can also choose to end the Chat and begin the Survey or click "Start new Chat", and we will immediately assign a new agent to continue your Chat. We apologize for any inconvenience caused',
    AGAIN: "Start new Chat",
  },
  VIDEOCALL: {

const lan = {
  ...
  CHAT_CLOSE: {
    H1: "Your network has been down for more than 300 seconds. Chat conversation has been terminated.",
    DESC: "If you are using wireless connection or mobile network, please move to a location with stronger signal reception or switch to a wired connection. We are sorry for the inconvenience.",
    CLOSE: "Close the window",
  },
  SURVEY_DONE: {

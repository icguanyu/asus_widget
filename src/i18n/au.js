const lan = {
  ...
  SURVEY_DONE: {
    ...
    P1: 'Thank you for completing the Service Satisfaction Survey; your feedback drives our continuous improvement. If you require additional Service or Support, please click "Start new Chat"; otherwise, click "Close the window" to finish the Chat if we have resolved your query',

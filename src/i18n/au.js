const lan = {
  ...
  RULE: {
    ...
    PRODUCTSN: "Please enter your devices Serial Number",
    PRODUCTSN_LEN: "Please enter twelve to fifteen letters or numbers",
  ...
  SYS: {
    HEAD: "System",
    NOSERVICE:
      "Sorry, Chat for your selected country or region is not available.",
    CHECK_FILESIZE:
  ...
  SURVEY: {
    ...
    AGE_LIMIT: "Age Limit",
    AGE_LIMIT_DESC: "You do not meet the age requirements to use Chat",
    REPEAT_ENTRY: {
  ...
  CONNECTTING: {
    ...
    P2: "The Chat is connecting you to an available Agent",
    NOTE: "Hint",
    BEFORE_LEAVE: "Are you sure you want to terminate your Chat?",
    B0: "Finish",
    B1: "Stay and wait",
  },
  OFFLIEN: {
  ...
  WAITTING: {
    ...
    LEAVE_DESC: "If you no longer wish to queue, you can finish the Chat",
  ...
  SURVEY_DONE: {
    ...
    P1:
      'Thank you for completing the Service Satisfaction Survey; your feedback drives our continuous improvement. If you require additional Service or Support, please click "Start new Chat"; otherwise, click "Close the window" to finish the Chat if we have resolved your query',

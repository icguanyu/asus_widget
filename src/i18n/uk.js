const lan = {
  ...
  SURVEY: {
    ...
    REPEAT_ENTRY: {
      ...
      P1: "Are you sure you want to start a new conversation? When a new conversation is opened, the old conversation will be closed.",
      B0: "Confirm",
      B1: "Cancel",
    },
  },
  ...
  CHAT_CLOSE: {
    ...
    DESC: "If you are using a wireless or a mobile network, please move to a location with a stronger signal; or switch to a wired network connection. We are sorry for any inconvenience caused",
    CLOSE: "Close the window",
  },
  SURVEY_DONE: {
  ...
  GPT: {
    ...
    END_SURVEY_MSG: "We are please to provide our service to you. Please reach out for future support.",

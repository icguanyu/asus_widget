const lan = {
  ...
  VIDEOCALL: {
    ...
    H1: "Ready to join?",
    P1:
      "To let ASUS service agents help you solve problem more efficiently, you must allow your device to access camera and microphone to join video call. Please ensure your mobile network connection works stably.",
    P2:
      "After accessing, you can still switch on or off camera and mute microphone.",
    VIDEO_STATE: "Camera status",
    VIDEO_ON: "On",
    VIDEO_OFF: "Off",
    AUDIO_STATE: "Microphone status",
    AUDIO_ON: "On",
    AUDIO_OFF: "Off",
    ENTER: "Join",
    HANGUP: {
      H1: "Hang up",
      P1: "Are you sure to hang up the video call?",
      CONFIRM: "Confirm",
      CANCEL: "Cancel",
    },
    END: {
      ...
      P1:
        "Thank you. This video call has ended. Now you can close this window.",
    },
  },
  GPT: {
    LAYOUT: {

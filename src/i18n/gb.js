const lan = {
  ...
  COUNTRY: { SELECT_COUNTRY: "Please select your Service country or region" },
  POLICY: {
  ...
  SURVEY: {
    ...
    AGE_LIMIT: "Age Limit",
    AGE_LIMIT_DESC: "You do not meet the age requirements to use the ASUS Chat",
    REPEAT_ENTRY: {
      H1: "Existing chat room detected",
      P1:
        "Are you sure you want to start a new conversation? When a new conversation is opened, the old conversation will be closed.",
      B0: "Confirm",
      B1: "Cancel",
    },
  },
  ...
  WAITTING: {
    ...
    PEOPLE: "Customer",
    NOTE: "Hint",
    BEFORE_LEAVEL: "Are you sure you wish to leave the queue?",
    LEAVE_DESC: "If you want to leave the queue, you can end the Chat",
    LEAVE: "End the Chat",
  ...
  CHATROOM: {
    ...
    SAT_SURVEY: {
      ...
      OTHER_OPTION: "Other",
      OTHER_REASON: "Please fill in Other reason",
      SEND: "Send",
    },
    CLOSE: {
  ...
  CHAT_CLOSE: {
    ...
    DESC:
      "If you are using a wireless or a mobile network, please move to a location with a stronger signal; or switch to a wired network connection. We are sorry for any inconvenience caused",
    CLOSE: "Close the window",
  },
  SURVEY_DONE: {

const lan = {
  ...
  GPT: {
    LAYOUT: {
      ...
      WAIT: "Vui lòng đợi",
      INPUT: "Nhập ký tự",
      TRANSFER_TOAGENT: "Chuyển đến nhân viên hỗ trợ.",
      READMORE: "Bạn cũng có thể tham khảo FAQ liên quan, cảm ơn",
      COLLAPSE: "Ẩn",
    },
    HEAD: {
      LEAVE: "Rời khỏi",
      CREATE_NEW: "Tạo phòng chat mới",
    },
    ENTRANCE: {
      POLICY: "Chính sách bảo mật",
      AGREE: "Nhấn Đồng ý để bắt đầu hội thoại",
    },
    MESSAGE: {
      WAIT: "Vui lòng đợi trong giây lát, chúng tôi đang tìm giải pháp cho bạn.",
    },
    END: "Cuộc trò chuyện đã kết thúc",
    END_MSG: "Chúng tôi rất vui được phục vụ bạn. Cuộc trò chuyện đã kết thúc.",
    END_SURVEY: "Khảo sát mức độ hài lòng",
    END_SURVEY_MSG: "Chúng tôi rất vui được phục vụ bạn. Cuộc trò chuyện đã kết thúc.",
    BACKHOME: "Quay lại trang chủ",
    SURVEY: {
      DESC: "Vui lòng đánh giá trải nghiệm của bạn với trợ lý ảo ASUS.",
      SAT: "Hài lòng",
      DISSAT: "Không hài lòng",
      FEEDBACK: "Vui lòng gửi cho chúng tôi phản hồi của bạn.",
      SEND: "Gửi",
      BACK: "Hủy",
    },
  },
